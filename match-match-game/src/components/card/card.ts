...
export class Card extends BaseComponent {
  ...
  addColorBlock(isRight: boolean) {
    if (isRight) {
      const colorBlock = new BaseComponent('div', ['right-answer', 'answer']);
      this.element.appendChild(colorBlock.element);
    } else {
      const colorBlock = new BaseComponent('div', ['wrong-answer', 'answer']);
      this.element.appendChild(colorBlock.element);
    }
  }
